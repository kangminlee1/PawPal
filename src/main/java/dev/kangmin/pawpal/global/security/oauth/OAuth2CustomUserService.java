package dev.kangmin.pawpal.global.security.oauth;
...
import dev.kangmin.pawpal.global.security.oauth.info.GoogleUserInfo;
import dev.kangmin.pawpal.global.security.oauth.info.KakaoUserInfo;
import dev.kangmin.pawpal.global.security.oauth.info.NaverUserInfo;
import dev.kangmin.pawpal.global.security.oauth.info.OAuth2UserInfo;
...
public class OAuth2CustomUserService extends DefaultOAuth2UserService {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException, CustomException {
        ...
        //만약 사용자 없으면 생성
        if (!memberRepository.existsByIdentify(generateDto.getIdentify())) {
